...
public sealed record SignalDetail(string Key, string Name, string Status, string ObservedFact, string Trigger, string Formula, string Threshold, string PeerDefinition, int? PeerSize, string ObservationWindow, string Limitations, string Version, IReadOnlyList<EvidenceRow> Evidence, int EvidenceTotal = 0, int Page = 1, int PageSize = 50, int TotalPages = 0);
